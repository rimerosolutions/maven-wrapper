...
public class PathAssemblerTest {
    ...
    public void distributionDirWithMavenUserHomeBase() throws Exception {
        configuration.setDistributionUris(Collections.singletonList(TEST_DISTRIBUTION_URI));
    ...
    public void distributionDirWithUnknownBase() throws Exception {
        configuration.setDistributionUris(Collections.singletonList(TEST_DISTRIBUTION_NO_TYPE_URI));
