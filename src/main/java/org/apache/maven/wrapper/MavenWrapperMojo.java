...
public class MavenWrapperMojo extends AbstractMojo implements Contextualizable {
    ...
    /**
     * DEPRECATED: Base distribution URL for the Maven binaries download. Use
     * baseDistributionUrlList instead.
     */
    private String baseDistributionUrl;

    @Parameter(property = "baseDistributionUrlList", required = false)
    /**
     * List of base distribution URLs for the Maven binaries download. Default
     * is:
    ...
    /**
     * The wrapper jar output folder. The location should be a sub-folder of the
     ...
     *
     * @param mavenVersion
     *            The Maven version to use for the wrapper
     */
    ...
    /**
     * Returns the wrapper base distribution URL list (Exposed for unit tests
     * only)
     *
    ...
    private String pathFromDequeWithFileSeparator(Deque<String> pathDeque, String separator) {
        Iterator<String> it = pathDeque.iterator();
        StringBuilder sb = new StringBuilder();
    ...
    public void execute() throws MojoExecutionException {
        try {
            ...
            generateWrapperScripts(wrapperFolder, wrapperSupportFolder);
    ...
    private void generateWrapperScripts(File baseDir, File wrapperDestFolder) throws IOException {
        final ClassLoader classLoader = Thread.currentThread().getContextClassLoader();
        final Deque<String> pathNameDeque = buildPathDeque(wrapperDestFolder, baseDir);
