...
/**
 * <p>
 * A command-line parser which supports a command/sub-command style command-line
 * interface. Supports the following syntax:
 * </p>
 *
 * <pre>
 ...
 * {@code --long-option}.</li>
 * <li>Options can take arguments. The argument follows the option. For example:
 * {@code -a arg} or {@code --long arg}.</li>
 * <li>Arguments can be attached to the option using '='. For example:
 * {@code -a=arg} or {@code --long=arg}.</li>
 * <li>Arguments can be attached to short options. For example: {@code -aarg}.
 * </li>
 ...
 * options do not need to be known at parse time. Use
 * {@link ParsedCommandLine#getExtraArguments()} to obtain the non-option
...
public class CommandLineParser {
     ...
     * @throws org.apache.maven.wrapper.cli.CommandLineArgumentException
     *             On parse failure.
     */
    ...
    private class KnownOptionParserState extends OptionParserState {
        ...
        private KnownOptionParserState(OptionString optionString, CommandLineOption option, ParsedCommandLine commandLine,
                ParserState state) {
